...
import { Command, Workflow } from "lucide-react"
      ...
      <main className="flex-1">
        <section className="space-y-6 pb-8 pt-6 md:pb-12 md:pt-10 lg:py-32">
          <div className="container flex max-w-[64rem] flex-col items-center gap-4 text-center">
            ...
            <p className="max-w-[42rem] leading-normal text-muted-foreground sm:text-xl sm:leading-8">
              ...
              and more with a powerful, easy to use dashboard. Easy. Open
              source.
            </p>
        ...
        >
          <div className="mx-auto flex max-w-[58rem] flex-col items-center space-y-4 text-center">
            ...
            <p className="max-w-[85%] leading-normal text-muted-foreground sm:text-lg sm:leading-7">
              ?? is a powerful, easy to use Discord bot dashboard that allows
              you to create dynamic commands, execute commands for every server
              event, create automations, and more.
            </p>
          </div>
              ...
              <div className="flex h-[180px] flex-col justify-between rounded-md p-6">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Create dynamic commands with ease.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="relative overflow-hidden rounded-lg border bg-background p-2">
              <div className="flex h-[180px] flex-col justify-between rounded-md p-6">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-sm">
                    Create workflows that execute commands for every server
                    event.
                  </p>
                </div>
              </div>
        ...
        <section id="open-source" className="container py-8 md:py-12 lg:py-24">
          <div className="mx-auto flex max-w-[58rem] flex-col items-center justify-center gap-4 text-center">
            ...
            <p className="max-w-[85%] leading-normal text-muted-foreground sm:text-lg sm:leading-7">
              ?? is open source and powered by open source software. <br /> The
